...
<body>
	...
	<div class="container form1" style="width:60%">
	    ...
	    <div class="signupform" > <h2>Enter The User Details</h2> </div>
		<div class="jumbotron">
		<form action="/signup.all" method="post" onSubmit="return validate(this)">
			 <fieldset>
		      <label>UserType<span class="required">*</span></label>
              ...
              <span id="usertype" class="test-danger"></span>
		    </fieldset>
			<fieldset>
		      <label>UserName<span class="required">*</span></label>
		      <span id="username" class="text-danger"></span>
		      <input placeholder="shubham@garg" name="username" type="text" class="form-control" value = "${username }" /><br>
		      <p><font color="red">${usernameMessage}</font></p>
		    </fieldset>
		    <fieldset>
		      <label>Email<span class="required">*</span></label>
		      <span id="email" class="text-danger"></span>
		      <input placeholder="shubham.garg@fin.co.in" name="email" type="email" class="form-control" value = "${email}"/><br>
		      <p><font color="red">${emailMessage}</font></p>
		    </fieldset>
		    <fieldset>
		      <label>Phone Number<span class="required">*</span></label>
		      <span id="phonenumber" class="text-danger"></span>
		      <input placeholder="0123456789" name="phonenumber" type="number" class="form-control" value = "${phonenumber}"/><br>
		      <p><font color="red">${phonenumberMessage}</font></p>
		    </fieldset>
		    <fieldset>
		      <label>Password<span class="required">*</span></label>
		      <span id="password" class="text-danger"></span>
		      <input placeholder="123456" name="password" type="password" class="form-control" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters"/><br>
		    </fieldset>
		    <fieldset>
		      <label>Confirm Password<span class="required">*</span></label>
		      <span id="cpassword" class="text-danger"></span>
		      <input placeholder="123456" name="cpassword" type="password" class="form-control" /><br>
		    </fieldset>
		    <fieldset>
		    ...
		    <fieldset>
		      ...
		      <input placeholder="shubham" name="firstname" type="text" class="form-control" value = "${firstname}" /><br>
		    </fieldset>
		    <fieldset>
		      <label>LastName<span class="required">*</span></label>
		      <span id="lastname" class="text-danger"></span>
		      <input placeholder="garg" name="lastname" type="text" class="form-control" value = "${lastname}" /><br>
		    </fieldset>
		    <fieldset>
		      <label>Age</label>
		      <input placeholder="25" name="age" type="number" class="form-control" value = "${age}" /><br>
		    </fieldset>
		    <fieldset>
		    ...
		    <fieldset>
		      <label>HouseNumber<span class="required">*</span></label>
		      <span id="housenumber" class="text-danger"></span>
		      <input placeholder="A34" name="housenumber" type="text" class="form-control" value = "${housenumber}" /><br>
		    </fieldset>
		    <fieldset>
		      <label>Locality<span class="required">*</span></label>
		      <span id="locality" class="text-danger"></span>
		      <input placeholder="Milap Nagar" name="locality" type="text" class="form-control" value = "${locality}"/><br>
		    </fieldset>
		    <fieldset>
		      <label>State<span class="required">*</span></label>
		      <span id="state" class="text-danger"></span>
		      <input placeholder="Delhi" name="state" type="text" class="form-control"value = "${state}"/><br>
		    </fieldset>
		    <fieldset>
		      <label>Country<span class="required">*</span></label>
		      <span id="country" class="text-danger"></span>
		      <input placeholder="India" name="country" type="text" class="form-control"value = "${country}"/><br>
		    </fieldset>
		    <fieldset>
		      <label>Area Pincode<span class="required">*</span></label>
		      <span id="pincode" class="text-danger"></span>
		      <input placeholder="110059" name="pincode" type="text" class="form-control"value = "${pincode}"/><br>
		    </fieldset> 
		    </fieldset>
